...
export default function PengeluaranPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 🔥 FILE UPLOAD (INI YANG BIKIN TIDAK 404)
      if (bukti) {
        ...
        <div className="bg-white/95 backdrop-blur-md border border-gray-300 rounded-xl shadow-md p-6 mx-[2cm] mb-10">
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option value="Operasional">
                  Operasional (Listrik, Internet dll)
                </option>
            ...
            <div>
              ...
              <label className="flex items-center gap-3 border p-3 rounded-xl bg-white cursor-pointer hover:bg-gray-50 transition">
